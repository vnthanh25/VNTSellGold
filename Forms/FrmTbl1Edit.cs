...
{
    public partial class FrmTbl1Edit : Form
    {
        #region Members *****************************************
        ...
        private void FrmTbl1Edit_Load(object sender, EventArgs e)
        {
            // Check empty on SCol1 column.
            lstCheckColumn.Add("SCol1");
            // TODO: This line of code loads data into the 'vNTSellGoldDataSet.Tbl1' table. You can move, or remove it, as needed.
            this.tbl1TableAdapter.Fill(this.vNTSellGoldDataSet.Tbl1);
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                this.tbl1TableAdapter.Update(this.vNTSellGoldDataSet.Tbl1);
            }
            catch (Exception ex)
            {
