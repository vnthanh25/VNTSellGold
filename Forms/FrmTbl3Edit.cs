...
{
    public partial class FrmTbl3Edit : Form
    {
        #region Members *****************************************
        ...
        private void FrmTbl3Edit_Load(object sender, EventArgs e)
        {
            // Check empty on SCol1 column.
            lstCheckColumn.Add("SCol1");
            // TODO: This line of code loads data into the 'vNTSellGoldDataSet.Tbl3' table. You can move, or remove it, as needed.
            this.tbl3TableAdapter.Fill(this.vNTSellGoldDataSet.Tbl3);
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                this.tbl3TableAdapter.Update(this.vNTSellGoldDataSet.Tbl3);
            }
            catch (Exception ex)
            {
        ...
        private void dataGridView1_RowValidating(object sender, DataGridViewCellCancelEventArgs e)
        {
            ...
            //string cap = VNTSellGold.Data.Controller.MtdGetResourceValue(typeof(FrmTbl3Edit), "CapError");
            //string mes = VNTSellGold.Data.Controller.MtdGetResourceValue(typeof(FrmTbl3Edit), "MesEmpty");
            ...
            if (dgv.Columns[e.ColumnIndex].Name.ToLower().Contains("dt"))
            {
                ...
                else
                {
                    ...
                    if (aDate.Length == 3)
                    {
                        ...
                        List<int> lstIndDate = VNTSellGold.App_Code.Controller.MtdGetIndexDateFormat();
